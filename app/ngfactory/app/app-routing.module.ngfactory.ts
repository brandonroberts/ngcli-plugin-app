...
import * as import12 from '../../home-view.component';
import * as import13 from '@angular/core/src/application_ref';
import * as import14 from '@angular/router/src/router';
import * as import15 from '@angular/core/src/linker/ng_module_factory_loader';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  constructor(parent:import7.Injector) {
    super(parent,[import8.HomeViewNgFactory],[]);
  }
  ...
  get _LocationStrategy_4():any {
    if ((this.__LocationStrategy_4 == (null as any))) { (this.__LocationStrategy_4 = import2.provideLocationStrategy(this.parent.get(import9.PlatformLocation),this.parent.get(import10.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_3)); }
  ...
  get _NgModuleFactoryLoader_8():import6.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_8 == (null as any))) { (this.__NgModuleFactoryLoader_8 = new import6.SystemJsNgModuleLoader(this.parent.get(import11.Compiler),this.parent.get(import6.SystemJsNgModuleLoaderConfig,(null as any)))); }
  ...
  get _Router_10():any {
    if ((this.__Router_10 == (null as any))) { (this.__Router_10 = import2.setupRouter(this.parent.get(import13.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import11.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3)); }
  ...
  createInternal():import1.AppRoutingModule {
    this._ROUTER_FORROOT_GUARD_0 = import2.provideForRootGuard(this.parent.get(import14.Router,(null as any)));
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import15.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_8; }
    if ((token === import16.ROUTES)) { return this._ROUTES_9; }
    if ((token === import14.Router)) { return this._Router_10; }
    if ((token === import17.ActivatedRoute)) { return this._ActivatedRoute_11; }
    if ((token === import18.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_12; }
